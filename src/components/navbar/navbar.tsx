    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex flex-row space-x-4 items-center">
            ...
            {navLinks.map((link, i) => (
              <li key={i}>
                <a 
                  ...
                  class={
                    active === link.tab 
                      ? "bg-stone-700 text-stone-300 rounded-md px-2 py-0.5" 
                      : "text-stone-700 rounded-md px-2 py-0.5 hover:bg-stone-200"
                  }
                >
                  { link.text }
                </a>
        ...
        <button
          ...
          class="bg-stone-300 rounded-md px-2 py-2 block md:hidden"
        >
          {!mobileNavOpen.value && (
            <svg class="fill-stone-600" width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
