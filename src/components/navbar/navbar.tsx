    ...
    <header class="sticky top-0 left-0 right-0 backdrop-blur text-mauvedark-50 py-3 h-[60px]">
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-row space-x-2 md:space-x-4 items-center">
                  ...
                  <a 
                    ...
                    class={
                      active === link.tab 
                        ...
                        : "text-mauvedark-700 rounded-md px-2 py-1 hover:bg-mauvedark-50/50"
                    }
                  >
                    { link.text }
                  </a>
          ...
          >
            {!mobileNavOpen.value && (
              <svg class="fill-mauvedark-600" width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
